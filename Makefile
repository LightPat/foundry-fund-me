...
install :; forge install cyfrin/foundry-devops@ && forge install smartcontractkit/chainlink-brownie-contracts@1.3.0 && forge install foundry-rs/forge-std@v1.8.2
